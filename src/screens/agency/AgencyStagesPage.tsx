import { travelDealStages } from "@/lib/agency-data";
import { formatRub } from "@/lib/provenance";

export function AgencyStagesPage() {
  return (
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">
            Клиент: ООО Путеш · Сумма сделки: 1 320 000 ₽ · Получено авансов:
            860 000 ₽
          </p>
        </div>
        <button
