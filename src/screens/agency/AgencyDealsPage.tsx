import { agencyDeals, agencyDealsDashboard } from "@/lib/agency-data";
import { formatRub } from "@/lib/provenance";

export function AgencyDealsPage() {
  return (
    <div className="space-y-5">
      ...
      >
        <Metric label="Всего" value="12" suffix="сделок" />
        <Metric
          label="Сумма сделок"
          value="5 930 000"
        ...
        <Metric
          ...
          progressLabel="44%"
          highlight="amber"
          hint="По одной сделке валовая прибыль ушла в минус"
        />
        <Metric
      ...
      <table className="w-full min-w-[900px] text-sm">
        <thead className="border-b border-slate-200 bg-slate-50 text-[11px] uppercase tracking-wide text-slate-600">
          <tr>
            ...
            <th className="px-3 py-2 text-left font-semibold">Сделка / клиент</th>
        ...
        <tbody className="divide-y divide-slate-100">
          ...
          <tr>
            ...
            >
              + 3 других сделок (всего 12) · Общая сумма сделок: 5 930 000 ₽
            </td>
          </tr>
        </tbody>
      </table>
