        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 rounded-md border border-emerald-200 bg-emerald-50/50 p-3 text-[12px] leading-relaxed text-slate-700">
              В тире разбора эти 4 цифры собираются автоматически из
              банк-выписки и карточки сделки. Не из Excel-сводки в конце месяца.
            </div>
          </div>
        </div>
      </div>
  ...
  const pains = [
    {
      ...
      problem:
        "Когда расхождение по контракту видно — деньги уже потрачены. По факту узнаёте через 30-45 дней после.",
      cost: "+15-30 дней до решения",
    },
    {
      tool: "Google Sheets",
      what: "Совместная таблица",
      problem:
        "Каждый прораб пишет по-своему, статьи расходятся, ссылки бьются. На сбор данных уходит больше времени, чем на разбор.",
      cost: "+2-4 часа в неделю на сборку",
    },
    {
      tool: "1С",
      what: "Бухгалтерская правда",
      problem:
        "Цифры верные, но они для налоговой. ОПиУ по управленческому смыслу собирать вручную. Этап и контракт — не видны.",
      cost: "+5-10 дней до закрытия периода",
    },
    {
      tool: "«Спрошу бухгалтера»",
      what: "Запрос в чат",
      problem:
        "Ответ через день-два, в формате «у нас сейчас на счетах X». Без разбивки по контрактам и этапам. Принять решение нельзя.",
      cost: "+1-2 дня на каждый вопрос",
    },
  ];
  ...
  const steps = [
    {
      ...
      desc: "Сверху — рентабельность по плану (25%) и по факту (17%). Один контракт ушёл ниже плановой маржи — он сразу подсвечен.",
    },
    {
      n: 2,
      title: "Карточка сделки → Этапы",
      desc: "Контракт разложен по этапам. Этап «Монтаж и пусконаладка» — план 1,8 млн, факт 0,56 млн. Разница видна в одной колонке.",
    },
    {
      n: 3,
      title: "Карточка сделки → Операции",
      desc: "Все операции по контракту: 4 выплаты монтажникам сверх плана, материалы по новой цене, гарантийное удержание. Цена расхождения в рублях с датами и контрагентами.",
    },
    {
      n: 4,
      title: "Виртуальный счёт + Платёжный календарь",
      desc: "Гарантийные удержания — отдельный виртуальный счёт. Календарь показывает кассовый разрыв за 2 недели до того, как он случится.",
    },
  ];
  ...
  return (
    <section id="tour" className="border-b border-slate-100 bg-slate-50/40">
      <div className="mx-auto max-w-6xl px-5 py-16">
        ...
        <p className="mt-3 max-w-3xl text-[15px] leading-relaxed text-slate-700">
          Разбор идёт по реальным модулям Финтабло. Тот же интерфейс, который
          увидит ваш финдиректор после подключения. Никаких заглушек.
        </p>
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {steps.map((s) => (
            <div
    ...
    <section className="bg-gradient-to-br from-emerald-50/60 via-white to-blue-50/40">
      <div className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-[16px] leading-relaxed text-slate-700">
          90 секунд на разбор «Климат-Сервиса». Без формы, без email на этом
